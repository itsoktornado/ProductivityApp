...
import com.example.productivityapp.feature_note.domain.util.NoteOrder
import com.example.productivityapp.feature_note.domain.util.OrderType
...
class NotesViewModel @Inject constructor(
    ...
    fun onEvent(event: NotesEvent) {
        when(event) {
            is NotesEvent.Order -> {
                // Not changing the order if already changed
